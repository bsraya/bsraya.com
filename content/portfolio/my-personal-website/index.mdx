...
[Gatsby.js](https://www.gatsbyjs.com) has a huge community which makes it friendly for beginners. In my spare time, I would help resolve the issues I have encountered before.
...
Thus, I spent significant amount of time on how to create a meaningful website. Here is a list of things I learned:
1. Users love blazing-fast websites
2. Simplicity is the best
3. Users expect to find relevant information within seconds
4. Some users prefer dark mode since it reduces blue light emitted from the screen and helps preserving battery life
5. Font size may affect reading experience

My personal website is the result of the aforementioned principles, and it will act as a medium where I can showcase my work and share my ideas. 