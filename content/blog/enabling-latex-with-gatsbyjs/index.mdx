...
However, I had to install `remark-html-katex` because it is used to wrap those HTML elements in the `<div class="katex-html">...</div>`. 
Without both of these, mathematical equations won't be shown in Latex format.

As for the katex options, there is a thorough documentation [here](https://katex.org/docs/options.html).
