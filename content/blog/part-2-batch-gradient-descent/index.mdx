...
Then we create a dataframe to store the result at each iteration and run the `python:bgd()` function for over 10,000 times.
...
After 10,000 iterations, the MSE value of our own Gradient Descent is $0.1955$ which is quite close to our baseline, which is $0.1910$.
...
If you want to know how those graphs were generated, [click here](https://www.kaggle.com/bijonsetyawan/part-1-gradient-descent) to check the Python notebook on Kaggle.
