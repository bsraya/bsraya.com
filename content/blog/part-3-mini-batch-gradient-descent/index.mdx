...
date: 2022-02-22
published: false
description: 'A Mini-Batch Gradient Descent implementation with Linear Regression in Python'
...
If you want to know how to implement it in more details, please [click here](https://www.kaggle.com/bijonsetyawan/mini-batch-gradient-descent) to check the Python notebook on Kaggle.
