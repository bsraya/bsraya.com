---
title: 'Part 2: Gradient Descent'
type: 'blog'
date: 2022-02-16
published: true
description: 'A Gradient Descent implementation with Linear Regression in Python'
...
$$
    \begin{aligned}
        \Theta_{0} = \Theta_0 - \frac{\alpha}{N} \sum_{i=1}^N (f(x) - y_i) \\
        \Theta_{1} = \Theta_1 - \frac{\alpha}{N} \sum_{i=1}^N (f(x) - y_i) x 
    \end{aligned}
$$
