...
1. R. Sebastian. An overview of gradient descent optimization algorithms. Source [https://ruder.io/optimizing-gradient-descent](https://ruder.io/optimizing-gradient-descent)
2. C. Kartik, M. Erik, A. Samantha, A. F. Emilio, D. Irene, G. Johann, G. Melissa, H. Basil, S. Steffi, T. Alanna, Y. Shannon. Gradient Descent: The Ultimate Optimizer. Source [https://arxiv.org/pdf/1909.13371.pdf](https://arxiv.org/pdf/1909.13371.pdf)