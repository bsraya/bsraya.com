...
In this case, the null hypothesis is _the average waiting time is 5 minutes_,
and the two sided alternative hypothesis is _the average waiting time is not 5 minutes_.
...
1. We are sure if the true mean is indeed `8.4`
2. The standard deviation is unknown
3. We should keep the number of random sample below 30

Take 25 random sample from ILEC population, and calculate its T-statistics.
...
Thus, we can accept the null hypothesis and conclude that _ILEC's average repair time is 8.4 seconds_.
