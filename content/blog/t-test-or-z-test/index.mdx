...
The core idea of hypothesis testing is to see if our experiement is repeatable and testable with scientific techniques, not merely an experiment with a result that is acquire by chance.
An experiment with an extreme result is not useful for anyone.
...
2. Repeatable and testable experiment is useful or more significant for everyone
...
6. Widely accepted alpha value is $0.05$, and migth differ on any circumstances
...
* [T-Value Interpretations and Considerations](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5059270/#:~:text=The%20%E2%80%9CP%E2%80%9D%20in%20P%20value,the%20evidence%20against%20H0)