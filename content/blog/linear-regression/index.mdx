...
1. Wikipedia. _Linear Regression_. Source [https://en.wikipedia.org/wiki/Linear_regression](https://en.wikipedia.org/wiki/Linear_regression)
2. J. Gareth, W. Daniella, H. Trevor, T. Robert. _An Introduction to Statistical Learning: With Applications in R_. Springer, 2013.