    ...
    return (
        <div>
            <div className="donationText">
                ...
                Your support is much appreciated so I can continue providing useful contents.
            </div>
            <a className="donationButton" href="https://paypal.me/bsraya" rel="nofollow noopener noreferrer">
